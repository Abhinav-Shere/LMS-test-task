...
ActiveRecord::Schema[8.0].define(version: 2025_07_20_110527) do
  ...
  create_table "reco_event_records", force: :cascade do |t|
    ...
    t.index ["aggregate_id", "sequence_number"], name: "index_reco_event_records_on_aggregate_id_and_sequence_number", unique: true
  end

  create_table "reco_snapshot_records", force: :cascade do |t|
    t.string "aggregate_id"
    t.integer "sequence_number"
    t.text "snapshot"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aggregate_id", "sequence_number"], name: "idx_on_aggregate_id_sequence_number_243295e60d", unique: true
  end

  create_table "reco_stream_records", force: :cascade do |t|
    t.string "aggregate_type"
    t.string "aggregate_id"
    t.integer "snapshot_threshold"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aggregate_type", "aggregate_id"], name: "index_reco_stream_records_on_aggregate_type_and_aggregate_id", unique: true
  end
